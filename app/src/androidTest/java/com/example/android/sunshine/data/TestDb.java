...
public class TestDb extends AndroidTestCase {
    ...
    /**
     *  Here is where you will build code to test that we can insert and query the location database.
     *  You'll want to look in TestUtilities where you can find the "createNorthPoleLocationValues()"
    ...
    /**
     *  Here is where you will build code to test that we can insert and query the db.

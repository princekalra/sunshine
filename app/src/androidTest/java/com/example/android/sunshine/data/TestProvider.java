...
public class TestProvider extends AndroidTestCase {
    ...
    /**
        This test uses the provider to insert and then update the data. Use this test to
    ...
    /**
     *  It relies on insertions with testInsertReadProvider, so insert and query functionality must
     *  also be complete before this test can be used.
     */
    ...
    //
    // Try this test after you have completed writing the delete functionality
    ...
    // Try this test after you have completed writing the BulkInsert functionality

 ...
 * Note that it doesn't take advantage of new adapter features to track changes in the underlying data.
 */
public class ItemChoiceManager {
    ...
    /**
     * Defines the choice behavior for the RecyclerView.
     * By default, RecyclerViewChoiceMode does not have any choice behavior (AbsListView.CHOICE_MODE_NONE).
     * By setting the choiceMode to AbsListView.CHOICE_MODE_SINGLE,
     * the RecyclerView allows up to one item to  be in a chosen state.
     *
